...
class TelloC:
    def __init__(self):  
        ...
        # PID - Y (levo/desno)
        self.Kpy = 0.300                                            # Člen: P 0.500
        self.Kiy = 0.005                                            # Člen: I 0.010
    ...
    def CalculatePID(self, os, trenutnaVrednost): # os: 0/1/2/3 - katero os gledaš, trenutnaVrednost: trenutna x,y,z,yaw vrednost
        ...
        if self.izhod[os] > 15 and self.bubble == 0: 
            speed = 15 
        else:
        ...
        if self.izhod[os] > 10 and self.bubble == 1: 
            speed = 10 
        else:
            speed = int(self.izhod[os])
